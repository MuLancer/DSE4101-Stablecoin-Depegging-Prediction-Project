...
transaction_file_path <- "Project Phase 1/data/token_transfers_V3.0.0.csv"
price_data_dir <- "Project Phase 1/data/price_data/"
...
write_csv(df_transactions, "Project Phase 1/data/token_transfers_cleaned.csv")
write_csv(df_prices, "Project Phase 1/data/prices_cleaned.csv")
