...
df_transactions <- read_csv("Project Phase 1/data/token_transfers_cleaned.csv")
df_prices <- read_csv("Project Phase 1/data/prices_with_events_pricefeatures.csv")
...
write_csv(df_all, "Project Phase 1/data/df_all.csv")
