...
write_csv(df_features, file.path(DATA_DIR, "features_mulan.csv"))
...
ggsave(file.path(PLOT_DIR, "mulan_features.png"), p, width = 16, height = 14, dpi = 300)
print(p)
...
ggsave(file.path(PLOT_DIR, "mulan_heatmap.png"), p_heatmap, width = 18, height = 12, dpi = 300)
print(p_heatmap)
